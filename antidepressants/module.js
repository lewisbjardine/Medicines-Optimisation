// =========================================================
// Antidepressant Switching & Stopping Module
// =========================================================

// ---------- Global state ----------
let showAllAntidepressants = false;

// Meta option values for dropdowns
...
const antidepressants = [
  ...
  // MAOIs — specialist only (no automatic switching plan)
  {
    id: "phenelzine",
...
// =========================================================
// DROPDOWNS WITH SHOW ALL / HIDE EXTRA
// =========================================================

// Populate antidepressant dropdown with meta-options
function populateDrugSelect(selectEl, showAll = false, selectedValue = null) {
  selectEl.innerHTML = "";

  const limitedList = antidepressants
    .filter(d => d.ukLicensed)
    .slice(0, 10);
...
// Handle meta-options per dropdown
...
// Click-away to collapse back to limited list
